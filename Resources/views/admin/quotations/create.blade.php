...
@section('page_title')
    {{ __('doquot::app.quotations.create') }}
@stop
...
@section('content')
    ...
    @if ($errors->any())
        ...
        @endforeach        
    @endif
        <form id="form" method="POST" action="{{ route('admin.doquot.quotations.store') }}">
            @csrf

            <div class="page-header">
                <div class="page-title"><h1>{{ __('doquot::app.quotations.create') }}</h1></div>
                <div class="page-action"><button type="submit" class="btn btn-lg btn-primary">Add</button></div>
            </div>
            <div class="page-content">
                ...
                <div class="control-group {{ $errors->has('tax') ? 'has-error' : ''}}">
                    ...
                    <input id="tax" name="tax" class="control" value="{{ old('tax') }}">
                ...
                <div class="control-group {{ $errors->has('validity') ? 'has-error' : ''}}">
                    ...
                    <input class="control" name="validity" id="validity">
    ...
    $(document).ready(function() {
        ...
        $('#btnAddProduct').click(function(e) {
            ...
            <tr>
                ...
                <td>${quantity}</td>
                <td>${subtotal}</td>
                <td><a href="#" class="btnRemoveProduct" data-product-id="${product_id}"><span class="icon trash-icon"></span></a></td>
